...
import com.youtube.sorcjc.fullday2016.wizard.ui.PonenteInfoBFragment;
 ...
 */
public class PonenteInfoBPage extends Page {
    public static final String NAME_DATA_KEY = "name";
    public static final String EMAIL_DATA_KEY = "email";
    protected ArrayList<String> mChoices = new ArrayList<String>();

    public PonenteInfoBPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return PonenteInfoBFragment.create(getKey());
    }
