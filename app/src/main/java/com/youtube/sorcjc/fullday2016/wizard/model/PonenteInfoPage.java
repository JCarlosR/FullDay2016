...
import com.youtube.sorcjc.fullday2016.wizard.ui.PonenteInfoFragment;
...
public class PonenteInfoPage extends Page {
    ...
    public PonenteInfoPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return PonenteInfoFragment.create(getKey());
    }
